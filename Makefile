...
run_test_docker:
	chmod +x shell/check_env_vars.sh
	./shell/check_env_vars.sh 
	docker-compose -f ./docker/composes/docker-compose.test.yml --env-file ./.env down -v
	docker-compose -f ./docker/composes/docker-compose.test.yml --env-file ./.env up -d
